...
//                inputUserRole.getRole().getUserRoleList().add(inputUserRole);
            ...
            Utility.showMessage(FacesMessage.SEVERITY_INFO, "User Role saved", "");
        } catch (Exception e) {
            Utility.showMessage(FacesMessage.SEVERITY_ERROR, "Could not save user role", e.getMessage());
    ...
    public void deleteEntity() {
        try {
            ...
            Utility.showMessage(FacesMessage.SEVERITY_ERROR, "Could not delete user role", e.getMessage());
            RequestContext.getCurrentInstance().addCallbackParam("success", false);
            System.out.println(e);
        }
    }
